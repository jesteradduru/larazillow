  ...
  <form @submit.prevent="update">
    <div class="grid grid-cols-6 gap-4">
      <div class="col-span-2">
        ...
        <input v-model.number="form.beds" class="input-text" type="text" />
      ...
      <div class="col-span-2">
        ...
        <input v-model.number="form.area" type="text" class="input-text" />
        <div v-if="form.errors.area" class="input-error">{{ form.errors.area }}</div>
      </div>
  
      <div class="col-span-4">
        <label class="label">City</label>
        <input v-model="form.city" type="text" class="input-text" />
        <div v-if="form.errors.city" class="input-error">{{ form.errors.city }}</div>
      </div>
  
      <div class="col-span-2">
        <label class="label">Post Code</label>
        <input v-model="form.code" type="text" class="input-text" />
      ...
      <div class="col-span-2">
        ...
        <input v-model.number="form.street_nr" type="text" class="input-text" />
        <div v-if="form.errors.street_nr" class="input-error">{{ form.errors.street_nr }}</div>
      </div>
  
      <div class="col-span-6">
        <label class="label">Price</label>
        <input v-model.number="form.price" type="text" class="input-text" />
