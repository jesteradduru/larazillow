...
const filter =() => form.get(route('listing.index'), 
  {
    preserveState: true,
    preserveScroll: true,
  },
  ...
  <form @submit.prevent="filter">
    <div class="mb-8 mt-4 flex flex-wrap gap-2">
      <div class="flex flex-nowrap items-center">
        <input
          v-model="form.priceFrom" type="text"
          placeholder="Price from"
          class="input-filter-l w-28"
        />
        <input
          v-model="form.priceTo" type="text" 
      ...
      <div class="flex flex-nowrap items-center">
        <input
          v-model="form.areaFrom" type="text"
          placeholder="Area from"
          class="input-filter-l w-28"
        />
        <input
          v-model="form.areaTo" type="text"
          placeholder="Area to"
          class="input-filter-r w-28"
        />
      </div>
